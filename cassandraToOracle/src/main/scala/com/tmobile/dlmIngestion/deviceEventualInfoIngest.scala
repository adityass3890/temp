...
object deviceEventualInfoIngest {

  @transient lazy val logger = org.apache.log4j.LogManager.getLogger(deviceEventualInfoIngest.getClass)
  ...
  def main(args: Array[String]): Unit = {
    ...
    var extractionDf = CommonMethods.readFromCSVFile(outboundPath + "/*part*", "|", spark, SchemaDefinition.deviceeventualinfoSchema)
    extractionDf=extractionDf.dropDuplicates("serialnumber")
