...
object dualImeiPrimaryCassToOracle {

  @transient lazy val logger = org.apache.log4j.LogManager.getLogger(dualImeiPrimaryCassToOracle.getClass)
  ...
  def main(args: Array[String]): Unit = {
    ...
    CommonMethods.log4jLogGenerate(logger, extractConfig.getString("warehouse.logdir"), "dualImeiPrimaryCassToOracle")
    ...
    val conf = new SparkConf(true).setAppName("dualImeiPrimaryCassToOracle")
